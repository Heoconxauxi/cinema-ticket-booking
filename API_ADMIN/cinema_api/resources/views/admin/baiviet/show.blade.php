    ...
    <div class="col-xl-10 col-lg-12 mx-auto"> {{-- Cho rộng hơn một chút --}}
        ...
        <div class="card">
            ...
            <div class="card-body pt-0">
                ...
                @if ($baiviet->Anh)
                    <img src="{{ Storage::url('uploads/baiviet/' . $baiviet->Anh) }}" 
                         alt="{{ $baiviet->TenBV }}" class="img-fluid mb-3" 
                         style="max-height: 400px; width: auto; display: block; margin-left: auto; margin-right: auto; border-radius: 8px;">
                @endif
