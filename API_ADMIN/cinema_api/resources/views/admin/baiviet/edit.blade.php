...
<div class="row">
    <div class="col-xl-12 col-lg-12 mx-auto">
        ...
        <form id="editBaiVietForm" action="{{ route('admin.baiviet.update', $baiviet->Id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                {{-- CỘT BÊN TRÁI --}}
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control @error('MoTa') is-invalid @enderror" id="MoTa" name="MoTa" rows="3">{{ old('MoTa', $baiviet->MoTa) }}</textarea>
                                @error('MoTa')
                                <small class="text-danger m-2 text-xs">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control @error('ChiTiet') is-invalid @enderror" id="ChiTiet" name="ChiTiet" rows="15">{{ old('ChiTiet', $baiviet->ChiTiet) }}</textarea>
                                @error('ChiTiet')
                                <small class="text-danger m-2 text-xs">{{ $message }}</small>
                                @enderror
                            </div>
