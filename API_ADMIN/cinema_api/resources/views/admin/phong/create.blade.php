...
@section('title', 'Thêm mới Phòng Chiếu')
...
<div class="row">
    <div class="col-xl-8 col-lg-10 mx-auto">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="addPhongForm" action="{{ route('admin.phong.store') }}" method="POST">
                    @csrf 
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('TenPhong') is-invalid @enderror" 
                               ...
                               value="{{ old('TenPhong') }}" placeholder="Nhập tên phòng (ví dụ: Rạp 1, Phòng 2...)">
